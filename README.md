...
Poe Finer Search Options is a userScript enhancing the official Path of exile [trade](https://www.pathofexile.com/trade) website by adding ability to include/exclude any item mod directly from a search result list so that you dont have to go to filter option back and forth.  
